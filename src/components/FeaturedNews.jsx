  ...
  return (
    <section className="space-y-4">
      <div className="bg-nh-blue h-40 md:h-56 rounded-lg flex items-center justify-center text-white relative overflow-hidden">
        ...
        <h1 className="text-3xl md:text-5xl font-bold relative z-10 text-center px-4">{title}</h1>
      </div>
      <div className="bg-card rounded-lg shadow-sm border p-6 animate-fade-in">
        ...
        <h2 className="text-xl md:text-2xl font-bold mb-3 text-card-foreground leading-tight">{headline}</h2>
        <p className="text-sm text-muted-foreground mb-4 leading-relaxed">{excerpt}</p>
        <Button variant="news" onClick={onReadMore} className="group">
          Read Full Story
